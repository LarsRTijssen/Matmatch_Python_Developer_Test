...
def test_cleaning():
	'''
	This test goes through all of the individual steps of cleaning the data and prints each step so it's easier to find any fails.
	input and expected output can be found in the unit_tests folder
	'''
